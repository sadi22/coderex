...
class Team extends Component {   
    ...
    render() {
        ...
        return (
            <Fragment>
                <section className="cr-team section-padding">
                        ...
                        <div className="cr-row">
                            <div className="cr-col">
                                ...
                                <div className="team-wrapper">
                                    {content.team_member.map((teamItem, index) => {
                                        
                                        return(                                            
                                            <div className="single-member" key={index}>
                                                <div className="member-img">
                                                    {teamItem.member_image &&
                                                        <img src={teamItem.member_image.url} alt="member img" className="img-fluid" />
                                                    }
                                                    <div className="social-contact">
                                                        <ul>
                                                        
                                                        {teamItem.social_links && 
                                                            teamItem.social_links.map((socialItem, index) => {
                                                                let social_profile_link = socialItem.social_profile_url ? socialItem.social_profile_url.url : '#';
                                                                return( 
                                                                    <li key={index}>
                                                                        {socialItem.social_profile_url &&
                                                                            
                                                                            <a href={social_profile_link} title={socialItem.social_profle_type} target="_blank">
                                                                                { socialItem.social_profle_type == 'facebook' && 
                                                                                ...
                                                                                { socialItem.social_profle_type == 'twitter' && 
                                                                                ...
                                                                                { socialItem.social_profle_type == 'linkedin' && 
                                                                                ...
                                                                                { socialItem.social_profle_type == 'behance' && 
                                                                                ...
                                                                                { socialItem.social_profle_type == 'codepen' && 
                                                                                ...
                                                                                { socialItem.social_profle_type == 'wordpress' && 
                                                ...
                                                <h6 className="circular-700">{parse(teamItem.name)}</h6>
                                                <span className="text-uppercase">{parse(teamItem.position)}</span>
                                            </div>
                                        )
                                    })}
